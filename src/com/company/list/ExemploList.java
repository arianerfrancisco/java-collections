...
public class ExemploList {
    public static void main(String[] args) {
        ...
        -----------------------------------------------------------------------------------------
        ArrayList<Double> notas = new ArrayList<>(); Nota: não é uma boa prática, já que  recomendado-se
        programar de acordo com a interface (List por exemplo)  e não a implementação.
        Generics: <Double> jdk5
        Diamond Operator <> de new ArrayList<>() > jdk 7
        -----------------------------------------------------------------------------------------
        List<Double> notas = new ArrayList<>(Arrays.asList(7d, 8.5, 9.3, 5d, 7d, 0d, 3.6));
        -----------------------------------------------------------------------------------------
        List<Double> notas = Arrays.asList(7d, 8.5, 9.3, 5d, 7d, 0d, 3.6); // essa forma torna a lista limitada
        já que não pode adicionar ou remover elementos dela.
        -----------------------------------------------------------------------------------------
